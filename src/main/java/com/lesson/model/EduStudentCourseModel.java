...
public class EduStudentCourseModel {
    ...
    public StudentCourseOperationRecordVO transferCourse(Long id, StudentCourseTransferRequest request) {
        ...
        targetRecord.setCampusName(sourceRecord.getCampusName());
        ...
        operationRecord.setCourseName(sourceRecord.getCourseName());
        ...
        operationRecord.setSourceCourseName(sourceRecord.getCourseName());
        operationRecord.setTargetCourseId(request.getTargetCourseId());
        operationRecord.setTargetCourseName(request.getTargetCourseName());
    ...
    public StudentCourseOperationRecordVO transferClass(Long id, StudentCourseClassTransferRequest request) {
        ...
        operationRecord.setCourseName(record.getCourseName());
    ...
    private StudentCourseRecord convertToDetailRecord(Record record) {
        ...
        detailRecord.setCourseName(studentCourse.getCourseName());
        detailRecord.setCourseType(studentCourse.getCourseType());
        detailRecord.setCoachId(studentCourse.getCoachId());
        detailRecord.setCoachName(studentCourse.getCoachName());
        ...
        detailRecord.setCampusName(studentCourse.getCampusName());
        detailRecord.setInstitutionId(studentCourse.getInstitutionId());
        detailRecord.setInstitutionName(studentCourse.getInstitutionName());
    ...
    private StudentCourseOperationRecordVO convertToOperationRecordVO(EduStudentCourseOperationRecord record) {
        ...
        vo.setSourceCourseName(record.getSourceCourseName());
        vo.setTargetCourseId(record.getTargetCourseId());
        vo.setTargetCourseName(record.getTargetCourseName());
