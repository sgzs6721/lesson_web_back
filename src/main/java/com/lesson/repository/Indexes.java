...
public class Indexes {
    ...
    public static final Index SYS_COACH_IDX_COACHING_DATE = Internal.createIndex(DSL.name("idx_coaching_date"), SysCoach.SYS_COACH, new OrderField[] { SysCoach.SYS_COACH.COACHING_DATE }, false);
