...
public class SysUser extends TableImpl<SysUserRecord> {
    ...
    /**
     * The reference instance of <code>lesson_prod.sys_user</code>
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.id</code>. 主键ID
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.password</code>. 密码
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.real_name</code>. 真实姓名
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.phone</code>. 手机号
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.role_id</code>. 角色ID
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.institution_id</code>. 所属机构ID（超级管理员可为空或设为0）
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.campus_id</code>. 所属校区ID（超级管理员可为空）
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.avatar</code>. 头像URL
     */
    public final TableField<SysUserRecord, String> AVATAR = createField(DSL.name("avatar"), SQLDataType.VARCHAR(255), this, "头像URL");

    /**
     * The column <code>lesson_prod.sys_user.status</code>. 状态：0-禁用，1-启用
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.last_login_time</code>. 最后登录时间
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.created_time</code>. 创建时间
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.update_time</code>. 更新时间
     */
    ...
    /**
     * The column <code>lesson_prod.sys_user.deleted</code>. 是否删除：0-未删除，1-已删除
     */
    ...
    /**
     * Create an aliased <code>lesson_prod.sys_user</code> table reference
     */
    ...
    /**
     * Create a <code>lesson_prod.sys_user</code> table reference
     */
    public SysUser() {
