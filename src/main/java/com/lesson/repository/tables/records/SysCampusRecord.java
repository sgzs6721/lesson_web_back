...
public class SysCampusRecord extends UpdatableRecordImpl<SysCampusRecord> implements Record10<Long, String, String, Integer, BigDecimal, BigDecimal, BigDecimal, LocalDateTime, LocalDateTime, Byte> {
    ...
    @Override
    public Row10<Long, String, String, Integer, BigDecimal, BigDecimal, BigDecimal, LocalDateTime, LocalDateTime, Byte> valuesRow() {
    ...
    @Override
    public SysCampusRecord value2(String value) {
        setName(value);
        return this;
    }
    ...
    @Override
    public SysCampusRecord value4(Integer value) {
        setStatus(value);
        return this;
    }

    @Override
    public SysCampusRecord value5(BigDecimal value) {
    ...
    @Override
    public SysCampusRecord value8(LocalDateTime value) {
    ...
    @Override
    public SysCampusRecord value10(Byte value) {
        setDeleted(value);
        return this;
    }

    @Override
    public SysCampusRecord values(Long value1, String value2, String value3, Integer value4, BigDecimal value5, BigDecimal value6, BigDecimal value7, LocalDateTime value8, LocalDateTime value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SysCampusRecord(Long id, String name, String address, Integer status, BigDecimal monthlyRent, BigDecimal propertyFee, BigDecimal utilityFee, LocalDateTime createdTime, LocalDateTime updateTime, Byte deleted) {
        super(SysCampus.SYS_CAMPUS);
