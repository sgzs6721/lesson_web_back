...
CREATE TABLE edu_student_course_operation (
    ...
    source_course_id VARCHAR(32) COMMENT '原课程ID',
    source_course_name VARCHAR(100) COMMENT '原课程名称',
    target_course_id VARCHAR(32) COMMENT '目标课程ID',
    target_course_name VARCHAR(100) COMMENT '目标课程名称',
    source_class_id VARCHAR(32) COMMENT '原班级ID',
    source_class_name VARCHAR(100) COMMENT '原班级名称',
    target_class_id VARCHAR(32) COMMENT '目标班级ID',
